		...
		<>
			<div>
				<div className="w-full flex  items-center flex-col lg:flex-row ">
					<div className="lftcontainer px-[6rem] lg:px-[6rem] py-[3rem] lg:py-[3rem] lg:w-[70rem]">
						<h1 className="lg:text-5xl lg:font-bold lg:py-7 lg:font-['Gillroy']">
							S-mart way to rent your
							<span className="lg:text-[#D19C0A] font-['PP_Neue_Machina_Inktrap_Medium']">
								&nbsp; PGs
							</span>
						</h1>
						<p className="text-sm font-light lg:text-zinc-500 leading-tight">
