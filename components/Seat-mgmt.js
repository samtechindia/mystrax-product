...
const SeatMgmt = () => {
	return (
		<div className="flex lg:flex-row flex-col items-center justify-between w-full bg-[#F8F8F8] lg:p-10 font-['PP_Neue_Machina_Inktrap_Medium'] text-cyan-900">
			<div className="lg:w-1/2 w-full">
				<h1 className="text-5xl  font-semibold p-10 ">Room Seat Management</h1>
