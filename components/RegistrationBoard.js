...
const RegistrationBoard = () => {
	return (
		<div className="flex lg:flex-row flex-col items-center justify-between w-full lg:p-10 font-['PP_Neue_Machina_Inktrap_Medium'] text-yellow-600">
			<div className="lg:w-1/2 w-full">
				<h1 className="text-5xl  font-semibold p-10 ">Registration Board</h1>
