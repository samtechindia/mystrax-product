	...
	return (
		<div className="bg-[#fcffff]  flex lg:flex-row flex-col items-center justify-around lg:p-20 ">
			<div className="w-[90vw]">
				...
				<div className="h-[2px] w-10 bg-[#60C3AD] my-2 ml-3"></div>
				...
				<div className="lg:mx-[14rem] mx-[5.6rem] my-7">
					<button
						type="button"
						className="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-6 py-2.5 text-center me-2 mb-2 "
					>
						GET APP
					</button>
				</div>
			...
			<div>
				<div className=" bg-cyan-600 mt-[3rem] rounded-full h-[60vh] w-[60vh] relative ">
